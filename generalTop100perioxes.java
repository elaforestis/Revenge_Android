...
public class generalTop100perioxes  extends Activity
{
    ...
    private class requestTop100 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                printwriter.println("request_generaltop100perioxes"); // write the message to output stream

                InputStreamReader inputStreamReader = new InputStreamReader(socket.getInputStream());
                bufferedReader = new BufferedReader(inputStreamReader);
                do {
                    serverReply = bufferedReader.readLine();
                }while(serverReply==null || !serverReply.contains("generaltop100perioxes:"));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            serverReply = serverReply.replace("generaltop100perioxes:","");
