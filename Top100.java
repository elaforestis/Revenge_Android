...
public class Top100  extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        table_layout = (TableLayout) findViewById(R.id.top100table);
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!players[(int)tr.getTag()].equalsIgnoreCase("null")) {
                        Intent k = new Intent(Top100.this, profile.class);
    ...
    private class requestTop100 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                printwriter.println("request_top100"); // write the message to output stream

                InputStreamReader inputStreamReader = new InputStreamReader(socket.getInputStream());
                bufferedReader = new BufferedReader(inputStreamReader);
                do {
                    serverReply = bufferedReader.readLine();
                }while(serverReply==null || !serverReply.contains("top100:"));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            serverReply = serverReply.replace("top100:", "");
