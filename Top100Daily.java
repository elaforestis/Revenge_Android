...
public class Top100Daily  extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_top100_daily);
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!players[(int)tr.getTag()].equalsIgnoreCase("null")) {
                        Intent k = new Intent(Top100Daily.this, profile.class);
    ...
    private class requestTop100 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                printwriter.println("request_top100Daily"); // write the message to output stream

                InputStreamReader inputStreamReader = new InputStreamReader(socket.getInputStream());
                bufferedReader = new BufferedReader(inputStreamReader);
                do {
                    serverReply = bufferedReader.readLine();
                }while(serverReply==null || !serverReply.contains("top100Daily:"));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            serverReply = serverReply.replace("top100Daily:", "");
            ...
            for(int i = 0;i<playersPointsPerioxi.length;i++){
                ...
                if(playersPointsPerioxi[i].split(Pattern.quote("-$-"))[2].contains("-")) {
                    perioxi[i] = playersPointsPerioxi[i].split(Pattern.quote("-$-"))[2].split("-")[1];
                }else{
                    perioxi[i]=null;
                }
            }
