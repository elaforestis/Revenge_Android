...
public class highscores extends TabActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        tab1.setContent(new Intent(this, Top100Daily.class));

        tab3.setIndicator("Top περιοχές");
        tab3.setContent(new Intent(this,Top100perioxes.class));

        tab2.setIndicator("Top νομοί");
        tab2.setContent(new Intent(this, Top10nomoi.class));

        tab4.setIndicator("Άλλα");
        tab4.setContent(new Intent(this, otherHs.class));
