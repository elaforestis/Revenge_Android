...
public class Top100Perioxis  extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_top100_perioxis);
        ...
        serverReply = MyExpandableAdapter.serverReply.replace("replyTop100Perioxi:", "");
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!players[(int)tr.getTag()].equalsIgnoreCase("null")) {
                        Intent k = new Intent(Top100Perioxis.this, profile.class);
