...
public class Top10nomoi  extends Activity
{
    ...
    private class requestTop100 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                printwriter.println("request_top10nomoi"); // write the message to output stream

                InputStreamReader inputStreamReader = new InputStreamReader(socket.getInputStream());
                bufferedReader = new BufferedReader(inputStreamReader);
                do {
                    serverReply = bufferedReader.readLine();
                }while(serverReply==null || !serverReply.contains("top10nomoi:"));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            serverReply = serverReply.replace("top10nomoi:","");
