...
public class profileDaily extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_daily);
        ...
        if(profileGeneral.requestedUser!=null){
            settings.setVisibility(View.INVISIBLE);
            requestedUser = getIntent().getStringExtra("requestUser");
            username.setText(profileGeneral.requestedUser.substring(0, 1).toUpperCase() + profileGeneral.requestedUser.substring(1));
            challenge.setOnClickListener(this);
            chat.setOnClickListener(this);
            profileGeneral.requestedUser=null;
        }else {
            settings.setOnClickListener(this);
            chat.setVisibility(View.INVISIBLE);
            challenge.setVisibility(View.INVISIBLE);
        }
        profileHTML.setText(Html.fromHtml(profileGeneral.serverReply.split(Pattern.quote("profileDAILY:"))[1].replace("profileDAILY:","")));
        ...
        switch(v.getId()){
            case R.id.challenge:
                ...
                if(printwriter==null || printwriter.checkError() || SocketHandler.getSocket()==null){
                    ...
                    challenging=true;
                    dialog1 = new ProgressDialog(profileDaily.this);
