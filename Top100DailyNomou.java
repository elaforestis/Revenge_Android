...
public class Top100DailyNomou  extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_top100_daily_nomou);
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(!players[(int)tr.getTag()].equalsIgnoreCase("null")) {
                        Intent k = new Intent(Top100DailyNomou.this, profile.class);
    ...
    private class requestTop100 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                printwriter.println("requestTop100NomosDaily---"+ExpandableListMainActivity.nomosSelected); // write the message to output stream

                InputStreamReader inputStreamReader = new InputStreamReader(socket.getInputStream());
                bufferedReader = new BufferedReader(inputStreamReader);
                do {
                    serverReply = bufferedReader.readLine();
                }while(!serverReply.contains("replyTop100NomosDaily:"));
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            serverReply = serverReply.replace("replyTop100NomosDaily:", "");
