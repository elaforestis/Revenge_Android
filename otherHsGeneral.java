...
public class otherHsGeneral extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_hs_general);
        ...
        perioxiSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(otherHsGeneral.this,ExpandableListMainActivity.class);
                startActivity(i);
                ExpandableListMainActivity.signup = false;
                ExpandableListMainActivity.requestType = "generalPerioxi";
            }
        });
        nomosSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ExpandableListMainActivity.requestType = "generalNomos";
                Intent i = new Intent(otherHsGeneral.this,ExpandableListMainActivity.class);
                startActivity(i);
                ExpandableListMainActivity.signup = false;
            }
